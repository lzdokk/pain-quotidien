...
export default function ShareBar({ verse, ref_, title, lede, date }: P) {
  ...
  const story = () => {
    ...
    const sepY = y + 130;
    x.strokeStyle = soir ? 'rgba(143,169,196,.30)' : 'rgba(78,106,133,.28)';
    x.lineWidth = 2;
    x.beginPath(); x.moveTo(W / 2 - 120, sepY); x.lineTo(W / 2 + 120, sepY); x.stroke();
    ...
    // Le lien du site, en pied de page
    x.fillStyle = soir ? '#5E6A76' : '#8894A2'; x.font = '400 28px -apple-system,Helvetica,Arial';
    x.fillText(site, W / 2, H - 200);
